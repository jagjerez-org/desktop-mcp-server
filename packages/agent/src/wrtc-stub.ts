...
// Additional wrtc-specific exports (stubbed)
export class RTCVideoSource {
  constructor() {}
  createTrack(): MediaStreamTrack { return new MediaStreamTrack(); }
  destroy(): void {}
}
...
export const createImageData = () => ({ data: new Uint8ClampedArray(0) });
